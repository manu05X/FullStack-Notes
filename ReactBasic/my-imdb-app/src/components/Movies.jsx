...
const Movies = () => {
  ...
  */
  ...
  }, [pageNum]); // we are adding page numbers as dependencies in the useEffect as page numbers change due to state change we need to get new data as well

  return (
    <div>
      <div className="text-2xl font-normal text-center m-5">
        ...
        {moviesData.map((moviesObj, index) => {
          ...
          return (
            <MovieCard
              ...
              // handleAddtoWatchListProps={handleAddtoWatchListProp}
              // watchlist={watchlist}
      ...
      {/* Passing function as props to Pagination to handle nextPage and previousPage iteration*/}
      <Pagination
